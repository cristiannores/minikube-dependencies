...
const createSocket = require('kafkajs/src/network/socket')
const createRequest = require('kafkajs/src/protocol/request')
const Decoder = require('kafkajs/src/protocol/decoder')
const { KafkaJSConnectionError } = require('kafkajs/src/errors')
const { INT_32_MAX_VALUE } = require('kafkajs/src/constants')
const getEnv = require('kafkajs/src/env')
