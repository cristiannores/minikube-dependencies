const swapObject = require('kafkajs/src/utils/swapObject')
const networkEvents = require('kafkajs/src/network/instrumentationEvents')
const InstrumentationEventType = require('kafkajs/src/instrumentation/eventType')
