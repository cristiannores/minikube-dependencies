...
const createStateMachine = require('kafkajs/src/producer/eosManager/transactionStateMachine')
const assert = require('assert')

const STATES = require('kafkajs/src/producer/eosManager/transactionStates')
