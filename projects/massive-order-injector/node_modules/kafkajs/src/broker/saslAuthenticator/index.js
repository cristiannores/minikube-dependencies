const { requests, lookup } = require('kafkajs/src/protocol/requests')
const apiKeys = require('kafkajs/src/protocol/requests/apiKeys')
const PlainAuthenticator = require('kafkajs/src/broker/saslAuthenticator/plain')
const SCRAM256Authenticator = require('kafkajs/src/broker/saslAuthenticator/scram256')
const SCRAM512Authenticator = require('kafkajs/src/broker/saslAuthenticator/scram512')
const AWSIAMAuthenticator = require('kafkajs/src/broker/saslAuthenticator/awsIam')
const { KafkaJSSASLAuthenticationError } = require('kafkajs/src/errors')
