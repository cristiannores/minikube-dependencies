...
const { parse: parseV0 } = require('kafkajs/src/protocol/requests/saslAuthenticate/v0/response')
const { failIfVersionNotSupported } = require('kafkajs/src/protocol/error')
