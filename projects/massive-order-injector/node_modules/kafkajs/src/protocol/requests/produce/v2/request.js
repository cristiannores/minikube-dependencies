...
const { Produce: apiKey } = require('kafkajs/src/protocol/requests/apiKeys')
const MessageSet = require('kafkajs/src/protocol/messageSet')
const { Types, lookupCodec } = require('kafkajs/src/protocol/message/compression')
