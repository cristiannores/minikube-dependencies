...
const versions = {
  0: ({ groupId, sessionTimeout, memberId, protocolType, groupProtocols }) => {
    const request = require('kafkajs/src/protocol/requests/joinGroup/v0/request')
    const response = require('kafkajs/src/protocol/requests/joinGroup/v0/response')
  ...
  1: ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols }) => {
    const request = require('kafkajs/src/protocol/requests/joinGroup/v1/request')
    const response = require('kafkajs/src/protocol/requests/joinGroup/v1/response')
  ...
  2: ({ groupId, sessionTimeout, rebalanceTimeout, memberId, protocolType, groupProtocols }) => {
    const request = require('kafkajs/src/protocol/requests/joinGroup/v2/request')
    const response = require('kafkajs/src/protocol/requests/joinGroup/v2/response')
