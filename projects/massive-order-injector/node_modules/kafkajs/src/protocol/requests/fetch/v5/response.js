...
const { parse: parseV1 } = require('kafkajs/src/protocol/requests/fetch/v1/response')
const decodeMessages = require('kafkajs/src/protocol/requests/fetch/v4/decodeMessages')
