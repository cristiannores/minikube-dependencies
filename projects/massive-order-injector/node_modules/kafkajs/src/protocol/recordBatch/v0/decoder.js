...
const { KafkaJSPartialMessageError } = require('kafkajs/src/errors')
const { lookupCodecByRecordBatchAttributes } = require('kafkajs/src/protocol/message/compression')
const RecordDecoder = require('kafkajs/src/protocol/recordBatch/record/v0/decoder')
