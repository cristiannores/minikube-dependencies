const flatten = require('kafkajs/src/utils/flatten')
const sleep = require('kafkajs/src/utils/sleep')
const websiteUrl = require('kafkajs/src/utils/websiteUrl')
const arrayDiff = require('kafkajs/src/utils/arrayDiff')
const OffsetManager = require('kafkajs/src/consumer/offsetManager')
const Batch = require('kafkajs/src/consumer/batch')
const SeekOffsets = require('kafkajs/src/consumer/seekOffsets')
const SubscriptionState = require('kafkajs/src/consumer/subscriptionState')
const {
  events: { HEARTBEAT },
} = require('kafkajs/src/consumer/instrumentationEvents')
const { MemberAssignment } = require('kafkajs/src/consumer/assignerProtocol')
const {
  KafkaJSError,
